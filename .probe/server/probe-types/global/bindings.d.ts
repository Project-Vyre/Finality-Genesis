...
import {$AlmostKube$OutputWrapper, $AlmostKube$OutputWrapper$Type} from "packages/com/almostreliable/summoningrituals/compat/kubejs/$AlmostKube$OutputWrapper"
...
const SummoningOutput: typeof $AlmostKube$OutputWrapper
