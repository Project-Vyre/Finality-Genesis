...
import {$SummoningEventJS, $SummoningEventJS$Type} from "packages/com/almostreliable/summoningrituals/compat/kubejs/$SummoningEventJS"
...
export namespace SummoningRituals {
function start(handler: (event: $SummoningEventJS) => void): void
function complete(handler: (event: $SummoningEventJS) => void): void
}
