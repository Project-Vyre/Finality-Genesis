declare module "packages/artifacts/world/$CampsiteFeature" {
...
export class $CampsiteFeature extends $Feature<($NoneFeatureConfiguration)> {
...
public "placeChest"(level: $WorldGenLevel$Type, pos: $BlockPos$Type, random: $RandomSource$Type, facing: $Direction$Type): void
}
/**
 ...
 */
declare global {
export type $CampsiteFeature_ = $CampsiteFeature$Type;
}}
