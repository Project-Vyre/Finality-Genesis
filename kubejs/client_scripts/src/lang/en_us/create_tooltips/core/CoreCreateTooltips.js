...
ClientEvents.lang('en_us', event => {
  ...
  event.addAll('kubejs', {
    ...
    "item.kubejs.final_sword.tooltip.behaviour1": "Summons both an End Crystal and lightning bolt at the foe's location.",
    "item.kubejs.final_sword.tooltip.condition2": "Caution!",
    "item.kubejs.final_sword.tooltip.behaviour2": "Don't _accidentally_ hit your friends!",
    "item.kubejs.final_sword.tooltip.condition3": "Additional Info",
    "item.kubejs.final_sword.tooltip.behaviour3": "Strangely, you remember wielding it in a different universe where it went by the name _Gran Faust_ instead.",
