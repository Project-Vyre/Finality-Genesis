...
/**
 * @file Tips Mod lang handler. Some lines have been modified to add animations with Text Animator.
 */
...
ClientEvents.highPriorityAssets(event => {
  /**
   * Everything below is responsible to changing the formatting of the Tip title from the Tips mod and
   * the Aether mod.
   */
  let baseTipKeys = [
    "undead_damage",
