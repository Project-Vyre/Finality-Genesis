...
StartupEvents.registry('item', event => {
	...
	event.create('finality:incomplete_brass_singularity_core').displayName('Incomplete ')
	// singularity cores
	event.create('finality:andesite_singularity_core').displayName('Andesite Singularity Core').texture('finality:item/andesite_core').maxStackSize(1)
