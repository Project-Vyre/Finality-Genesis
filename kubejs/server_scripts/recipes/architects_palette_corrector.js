...
let MYONITE_ERRORED = [
    'architects_palette:vertslabs/myonite_vertical_slab',
    'architects_palette:vertslabs/myonite_vertical_slab_revert',
    'architects_palette:vertslabs/stonecutting/myonite_vslab_from_myonite_stonecutting',
    'architects_palette:vertslabs/myonite_brick_vertical_slab',
    'architects_palette:vertslabs/myonite_brick_vertical_slab_revert',
    'architects_palette:vertslabs/stonecutting/myonite_brick_vslab_from_myonite_and_myonite_bricks_stonecutting',
    'architects_palette:vertslabs/mushy_myonite_brick_vertical_slab',
    'architects_palette:vertslabs/mushy_myonite_brick_vertical_slab_revert',
    'architects_palette:vertslabs/stonecutting/mushy_myonite_brick_vslab_from_mushy_myonite_bricks_stonecutting'
]
...
ServerEvents.recipes(event => {
    MYONITE_ERRORED.forEach(recipeid => {
